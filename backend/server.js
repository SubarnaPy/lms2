...
// ////////////////////////////////////////////////////////////////////////////////////////////
    ...
    app.use(express.static(path.join(dirPath,"/frontendd/dist")));
    app.get('*', (req, res) => {
        res.sendFile(path.resolve(dirPath, "frontendd", "dist", "index.html"));
    })
    
        // res.sendFile(path.join(dirPath,"/frontendd/dist","index.html"));
